...
namespace VRoguePed
{
    public static class InputModule
    {
        ...
        public static void InitControlKeysFromConfig(ScriptSettings settings)
        {
            ...
            RegisterControlKey("ToggleRoguePedsEscortPlayerKey", settings.GetValue<String>("CONTROL_KEYBOARD", "ToggleRoguePedsEscortPlayerKey", "None"),
                (Action)delegate { ToggleRoguePedsEscortPlayerProc(); }, TriggerCondition.PRESSED);
